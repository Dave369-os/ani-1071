...
le programme qui affiche "bonjour" apres compilation laisse un fichier .exe de taille 71Ko qui s'execute correctement.  L'executable du programme affichant 'bonjour' est donc plus lourd que celui du programme n'ayant aucune bibliotheque.
...
7
```
NB: Le premier programme est celui retournant 7 et le deuxieme celui qui affiche 'bonjour' dans le cadre de ce rapport.